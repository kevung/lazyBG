...
<!--// https://heroicons.com/-->
<div class="toolbar">
    <button on:click|stopPropagation={onNewDatabase} aria-label="New Transcription" title="New Transcription (Ctrl-N)">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 10.5v6m3-3H9m4.06-7.19-2.12-2.12a1.5 1.5 0 0 0-1.061-.44H4.5A2.25 2.25 0 0 0 2.25 6v12a2.25 2.25 0 0 0 2.25 2.25h15A2.25 2.25 0 0 0 21.75 18V9a2.25 2.25 0 0 0-2.25-2.25h-5.379a1.5 1.5 0 0 1-1.06-.44Z" />
        </svg>
    </button>

    <button on:click|stopPropagation={onOpenDatabase} aria-label="Open Transcription" title="Open Transcription (Ctrl-O)">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onShowMetadata} aria-label="Transcription Metadata" title="Transcription Metadata (Ctrl-M)" disabled={statusBarMode !== 'NORMAL' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={handleFirstPosition} aria-label="Previous Game" title="Previous Game (First Move) (PageUp, h)" disabled={statusBarMode === 'EDIT' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="m18.75 4.5-7.5 7.5 7.5 7.5m-6-15L5.25 12l7.5 7.5" />
        </svg>
    </button>

    <button on:click|stopPropagation={handlePreviousPosition} aria-label="Previous Move" title="Previous Move (Left, k)" disabled={statusBarMode === 'EDIT' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
        </svg>
    </button>

    <button on:click|stopPropagation={handleNextPosition} aria-label="Next Move" title="Next Move (Right, j)" disabled={statusBarMode === 'EDIT' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
    </button>

    <button on:click|stopPropagation={handleLastPosition} aria-label="Next Game" title="Next Game (First Move) (PageDown, l)" disabled={statusBarMode === 'EDIT' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            <path stroke-linecap="round" stroke-linejoin="round" d="m5.25 4.5 7.5 7.5-7.5 7.5m6-15 7.5 7.5-7.5 7.5" />
        </svg>
    </button>  

    <button on:click|stopPropagation={handleGoToPosition} aria-label="Go To Move" title="Go To Move (Ctrl-K)" disabled={statusBarMode !== 'NORMAL' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onToggleEditMode} aria-label="Edit Mode" title="Edit Mode (Tab)" disabled={!databasePath && !hasTranscription}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onToggleMovesPanel} aria-label="Toggle Moves Panel" title="Toggle Moves Panel (Ctrl-P)" disabled={statusBarMode === 'EDIT' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
    ...
    <button on:click|stopPropagation={onShowCandidateMoves} aria-label="Show Candidate Moves" title="Show Candidate Moves (Ctrl-L)" disabled={statusBarMode === 'EDIT' || (!databasePath && !hasTranscription)}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
